...
class ContinueButton : public Component
{
public:
	...
	void SetSettingButton(const SettingButton& settingButton);
	SettingButton* GetSettingButton() { return settingButton; }
...
private:
	...
	SettingButton* settingButton = nullptr;
